...
UPDATE `script_texts`
SET content_loc6 = '¿Qué es esta brujería?', content_loc7 = content_loc6
WHERE entry = -1595099;
...
UPDATE `script_texts`
SET content_loc6 = 'Por fin algo de suerte. La Calle del Mercado aun no se ha incendiado. Se supone que Mal\'Ganis esta en la Plaza de los Cruzados, just delante. Avisadme cuando esteis preparados.', content_loc7 = content_loc6
WHERE entry = -1595116;
...
UPDATE `script_texts`
SET content_loc6 = 'Para tí no hay futuro.', content_loc7 = content_loc6
WHERE entry = -1595005;
...
UPDATE `script_texts`
SET content_loc6 = 'Busco al principe Arthas, no a tí...', content_loc7 = content_loc6
WHERE entry = -1595014;
